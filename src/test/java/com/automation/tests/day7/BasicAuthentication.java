...
public class BasicAuthentication {
    ...
    public void spartanAuthentication(){
        //in th egiven part, we provide request specifications
    ...
    public void authorizationTest(){
        ...
        given().
                ...
                //contentType(ContentType.JSON)-is optional
        when().
         ...
         * 403- Forbidden access.You logged in , but you are trying to do something that are you not allowed
